"""
FRESCO runner for executing calculations
"""
...
class FrescoRunner(QObject):
    """Class to run FRESCO calculations"""
    ...
    def run(self, executable, input_file, working_dir=None):
        """Run FRESCO with the given input file in specified working directory"""
